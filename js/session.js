...
var Session = function Session(options) {
  ...
  session.stages = [
          ...
          {label:'NET: layout and social', page:'canvasedge1.html'},
          {label:'NI: who recruited', page:'canvasselect2.html'},
          {label:'NI: who drunk with', page:'canvasselect3.html'},
          {label:'NI: who drugs with', page:'canvasselect4.html'},
          {label:'NI: who sex with', page:'canvasselect5.html'},
          {label:'ORD: contact frequency', page:'ordbin1a.html'},
          {label:'ORD: relationship strength', page:'ordbin1.html'},
          {label:'NI: get advice', page:'canvasselect6.html'},
          ...
          {label:'NI: alcohol', page:'canvasselect1.html'},
