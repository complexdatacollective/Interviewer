...
var Session = function Session(options) {
  ...
  session.stages = [
          ...
          {label:'RACE: American Indian/Alaska Native', page:'canvasselect9.html'},
          {label:'RACE: Asian', page:'canvasselect10.html'},
          {label:'RACE: Black or African American', page:'canvasselect11.html'},
          {label:'RACE: Native Hawaiian or OPI', page:'canvasselect12.html'},
          {label:'RACE: White', page:'canvasselect13.html'},
          {label:'RACE: Hispanic or Latino', page:'canvasselect14.html'},
          {label:'RACE: Other', page:'canvasselect15.html'},
