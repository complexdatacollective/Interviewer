...
var Session = function Session(options) {
  ...
  session.stages = [
          ...
          {label:'RACE/ETHNICITY: American Indian/Alaska Native', page:'canvasselect9.html'},
          {label:'RACE/ETHNICITY: Asian', page:'canvasselect10.html'},
          {label:'RACE/ETHNICITY: Black or African American', page:'canvasselect11.html'},
          {label:'RACE/ETHNICITY: Native Hawaiian or Other Pacific Islander', page:'canvasselect12.html'},
          {label:'RACE/ETHNICITY: White', page:'canvasselect13.html'},
          {label:'RACE/ETHNICITY: Hispanic or Latino', page:'canvasselect14.html'},
          {label:'RACE/ETHNICITY: Other', page:'canvasselect15.html'},
