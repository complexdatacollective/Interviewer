...
var Session = function Session(options) {
  ...
  session.stages = [
          ...
          {label:'CANVAS: who recruited', page:'canvasselect2.html'},
          {label:'CANVAS: who drunk with', page:'canvasselect3.html'},
          {label:'CANVAS: who drugs with', page:'canvasselect4.html'},
          {label:'CANVAS: who sex with', page:'canvasselect5.html'},
          {label:'ORD: contact frequency', page:'ordbin1a.html'},
          {label:'ORD: relationship strength', page:'ordbin1.html'},
          {label:'CANVAS: get advice', page:'canvasselect6.html'},
