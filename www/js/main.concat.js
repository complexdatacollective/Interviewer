...
module.exports = function ListSelect() {
    ...
    listSelect.init = function(options) {
        ...
        $.each(edges, function(index,value) {
          ...
          var el = $('<div class="item"><div class="inner" data-nodeid="'+node.id+'" data-toggle="collapse" data-target="#collapse-'+value.id+'" aria-expanded="false" aria-controls="collapse-'+value.id+'"><h4><i class="select-icon fa fa-circle-o pull-left"></i>'+node.name+'</h4></div></div>');

          var markup = $('<div class="collapse" id="collapse-'+value.id+'"><div class="well"><h5>Which services did you access? Click or tap all that apply</h5><div class="btn-group check"></div></div>');
            ...
            $.each(listSelect.options.variable.options, function(optionIndex, optionValue) {
                ...
                el.find('.check').append('<div class="col-md-12 text-left check-row"><input data-parent="'+node.id+'" name="'+listSelect.options.variable.label+'" type="checkbox" class="faChkRnd" id="check-'+index+optionIndex+'" data-value="'+optionValue+'" '+checked+'><label for="check-'+index+optionIndex+'">'+optionValue+'</label></div>');
            });
        });
            ...
            if(value.private !== true) {
                ...
                $('#name').autocomplete({
                    source: [
                        ...
                        'Lawndale Christian Health Center - Ogden Campus/Main Clinic',
                        ...
                        'PRCC - Integrated PASEO - Norwegian Hospital',
                        ...
                        'Prologue',
                        'Provident Hospital Hektoen HIV Program',
                        ...
                        'University of Chicago at Illinois Student Wellness Center (UIC)',
