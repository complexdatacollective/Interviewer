...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">71.6% <small>(1132 / 1581)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">61.66% <small>(476 / 772)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">66.94% <small>(162 / 242)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">71.9% <small>(1126 / 1566)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
3863
3864
3865</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    function containsCheckFn(a, b) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(a)) {
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >function (curr) {</span></span>
<span class="cstat-no" title="statement not covered" >          return a.indexOf(curr) !== -1;</span>
        };
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof a === 'string') {
...
&nbsp;
        checkFn = containsCheckFn(a, b) || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >          return false;</span>
        };
&nbsp;
...
&nbsp;
      for (i = 0; i &lt; len; i += 1) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.collections[i].name === collectionName) {
...
&nbsp;
      var obj = JSON.parse(serializedDb),
        i = 0,
        len = obj.collections ? obj.collections.length : <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
        coll,
        copyColl,
        clen,
        j;
...
<span class="cstat-no" title="statement not covered" >      this.fs.readFile(dbname, {</span>
        encoding: 'utf8'
...
&nbsp;
     ...
     */
    Loki.prototype.loadDatabase = <span class="fstat-no" title="function not covered" >function (options, callback) {</span>
<span class="cstat-no" title="statement not covered" >      var cFun = callback || <span class="fstat-no" title="function not covered" >function (err, data) {</span></span>
<span class="cstat-no" title="statement not covered" >          if (err) {</span>
...
<span class="cstat-no" title="statement not covered" >          if (typeof (dbString) === 'string') {</span>
<span class="cstat-no" title="statement not covered" >            self.loadJSON(dbString, options || {});</span>
...
<span class="cstat-no" title="statement not covered" >            if (typeof (dbString) === "object") {</span>
...
&nbsp;
      ...
      if (queryObject === 'getAll') {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.searchIsChained) {
          this.filteredrows = Object.keys(this.collection.data);
          return this;
        }
...
<span class="cstat-no" title="statement not covered" >                if (result.length === 0) <span class="cstat-no" title="statement not covered" >return [];</span></span>
&nbsp;
...
&nbsp;
    ...
    function DynamicView(collection, name, options) {
      ...
      this.options = options || {};
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.hasOwnProperty('persistent')) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.hasOwnProperty('sortPriority')) {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (options.hasOwnProperty('removeWhereFilters')) {
...
<span class="cstat-no" title="statement not covered" >      var copy = new DynamicView(this.collection, this.name, this.options);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this.resultdata;</span>
    };
&nbsp;
    /**
...
&nbsp;
    ...
    DynamicView.prototype.performSortPhase = function () {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.sortDirty &amp;&amp; !this.resultsdirty &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.resultset.filterInitialized)</span> {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.resultdata = this.resultset.data();</span>
<span class="cstat-no" title="statement not covered" >      this.resultsdirty = false;</span>
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.persistent) {
<span class="cstat-no" title="statement not covered" >          this.resultdata.push(this.collection.data[objIndex]);</span>
        }
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (oldPos !== -1 &amp;&amp; newPos === -1) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (oldPos &lt; oldlen - 1) {
...
<span class="cstat-no" title="statement not covered" >          ofr.length = oldlen - 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (this.options.persistent) {</span>
<span class="cstat-no" title="statement not covered" >            this.resultdata.length = oldlen - 1;</span>
          }
...
<span class="cstat-no" title="statement not covered" >      return { '$and': query };</span>
    };
&nbsp;
    Collection.prototype.findObject = <span class="fstat-no" title="function not covered" >function(template) {</span> <span class="cstat-no" title="statement not covered" >return this.findOne(this.byExample(template)); </span>};
&nbsp;
    Collection.prototype.findObjects = <span class="fstat-no" title="function not covered" >function(template) {</span> <span class="cstat-no" title="statement not covered" >return this.find(this.byExample(template)); </span>};
&nbsp;
    /*----------------------------+
    | INDEXING                    |
    +----------------------------*/
...
&nbsp;
    Collection.prototype.count = <span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
        obj = self.cloneObjects ? <span class="branch-0 cbranch-no" title="branch not covered" >JSON.parse(JSON.stringify(d)) </span>: d;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (self.add(obj)) {
...
&nbsp;
    Collection.prototype.mode = <span class="fstat-no" title="function not covered" >function (field) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (dict[obj]) {</span>
<span class="cstat-no" title="statement not covered" >          dict[obj] += 1;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          dict[obj] = 1;</span>
        }
      });
<span class="cstat-no" title="statement not covered" >      var max,</span>
        prop, mode;
<span class="cstat-no" title="statement not covered" >      for (prop in dict) {</span>
<span class="cstat-no" title="statement not covered" >        if (max) {</span>
<span class="cstat-no" title="statement not covered" >          if (max &lt; dict[prop]) {</span>
<span class="cstat-no" title="statement not covered" >            mode = prop;</span>
          }
        } else {
<span class="cstat-no" title="statement not covered" >          mode = prop;</span>
<span class="cstat-no" title="statement not covered" >          max = dict[prop];</span>
        }
      }
...
<span class="cstat-no" title="statement not covered" >      return this.keyMap[this.lokiMap[id]];</span>
    ...
    UniqueIndex.prototype.update = function (obj) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.lokiMap[obj.$loki] !== obj[this.field]) {
        var old = this.lokiMap[obj.$loki];
        this.set(obj);
        // make the old key fail bool test, while avoiding the use of delete (mem-leak prone)
        this.keyMap[old] = undefined;
      } else {
<span class="cstat-no" title="statement not covered" >        this.keyMap[obj[this.field]] = obj;</span>
      }
    };
...
<span class="cstat-no" title="statement not covered" >          this.values.splice(pos, 1);</span>
      ...
      // clear will zap the index
      clear: <span class="fstat-no" title="function not covered" >function (key) {</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Jul 06 2015 22:44:38 GMT+0100 (IST)</div>
</div>
