...
<html lang="en">
<head>
    <title>Code coverage report for src/lokiCryptedFileAdapter.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/lokiCryptedFileAdapter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; lokiCryptedFileAdapter.js</div>
</div>
<div class="body">
...
lokiCryptedFileAdapter.prototype.loadDatabase = function loadDatabase(dbname, callback) {
  ...
  var cFun = callback || <span class="branch-1 cbranch-no" title="branch not covered" >console.log;</span>
...
lokiCryptedFileAdapter.prototype.saveDatabase = function saveDatabase(dbname, dbstring, callback) {
  var cFun = callback || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >function (){</span>};</span>
