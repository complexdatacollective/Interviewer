...
export const undefinedFormVariables = (form, codebook) => form.fields
    .map(f => f.variable)
    .filter(variable => !codebook[form.entity][form.type].variables[variable]);
export const nodeVarsIncludeDisplayVar = node => !node.displayVariable // displayVariable is optional
