...
class Validator {
     ...
     */
    validateSingle(keypath, fragment, validation, subject) {
    ...
    validateSequence(keypath, fragment, sequence, subject) {
        sequence.every((s) => this.validateSingle(keypath, fragment, { validate: s.validate, makeFailureMessage: s.makeFailureMessage }, subject));
    }
    /**
