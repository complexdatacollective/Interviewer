...
function validate413(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    errors++;
} validate413.errors = vErrors; return errors === 0; }
function validate412(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; const _errs0 = errors; let valid0 = false; const _errs1 = errors; if (!(validate413(data, { instancePath, parentData, parentDataProperty, rootData }))) {
...
} validate412.errors = vErrors; return errors === 0; }
const func2 = Object.prototype.hasOwnProperty;
function validate411(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.type !== undefined) {
        ...
        if (!(((((((((data1 === "boolean") || (data1 === "text")) || (data1 === "number")) || (data1 === "datetime")) || (data1 === "ordinal")) || (data1 === "scalar")) || (data1 === "categorical")) || (data1 === "layout")) || (data1 === "location"))) {
            const err6 = { instancePath: instancePath + "/type", schemaPath: "#/properties/type/enum", keyword: "enum", params: { allowedValues: schema327.properties.type.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err6];
            }
            else {
    ...
    if (data.component !== undefined) {
        ...
        if (!(((((((((((((data2 === "Boolean") || (data2 === "CheckboxGroup")) || (data2 === "Number")) || (data2 === "RadioGroup")) || (data2 === "Text")) || (data2 === "TextArea")) || (data2 === "Toggle")) || (data2 === "ToggleButtonGroup")) || (data2 === "Slider")) || (data2 === "VisualAnalogScale")) || (data2 === "LikertScale")) || (data2 === "DatePicker")) || (data2 === "RelativeDatePicker"))) {
            const err8 = { instancePath: instancePath + "/component", schemaPath: "#/properties/component/enum", keyword: "enum", params: { allowedValues: schema327.properties.component.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err8];
            }
            else {
    ...
    errors++;
} validate411.errors = vErrors; return errors === 0; }
function validate410(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    for (const key0 in data) {
    ...
    errors++;
} validate410.errors = vErrors; return errors === 0; }
function validate409(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.name === undefined) {
    ...
    errors++;
} validate409.errors = vErrors; return errors === 0; }
function validate408(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    for (const key0 in data) {
        if (!(pattern0.test(key0))) {
            const err0 = { instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" };
            if (vErrors === null) {
    ...
    errors++;
} validate408.errors = vErrors; return errors === 0; }
const schema332 = { "type": "object", "additionalProperties": false, "title": "Edge", "patternProperties": { ".+": { "$ref": "#/definitions/EdgeTypeDef" } } };
const schema333 = { "type": "object", "additionalProperties": false, "properties": { "name": { "type": "string" }, "color": { "type": "string" }, "variables": { "$ref": "#/definitions/Variables" } }, "required": ["name", "color"], "title": "EdgeTypeDef" };
function validate421(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.name === undefined) {
        const err0 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "name" }, message: "must have required property '" + "name" + "'" };
        if (vErrors === null) {
            vErrors = [err0];
    ...
    errors++;
} validate421.errors = vErrors; return errors === 0; }
function validate420(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    for (const key0 in data) {
        if (!(pattern0.test(key0))) {
            const err0 = { instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" };
            if (vErrors === null) {
    ...
    errors++;
} validate420.errors = vErrors; return errors === 0; }
const schema334 = { "type": "object", "additionalProperties": false, "properties": { "variables": { "$ref": "#/definitions/Variables" } } };
function validate425(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    for (const key0 in data) {
        if (!(key0 === "variables")) {
            const err0 = { instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" };
            if (vErrors === null) {
    ...
    errors++;
} validate425.errors = vErrors; return errors === 0; }
function validate407(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    for (const key0 in data) {
    ...
    errors++;
} validate407.errors = vErrors; return errors === 0; }
const schema336 = { "type": "object", "additionalProperties": false, "properties": { "id": { "type": "string" }, "interviewScript": { "type": "string" }, "type": { "type": "string", "enum": ["Narrative", "AlterForm", "AlterEdgeForm", "EgoForm", "NameGenerator", "NameGeneratorQuickAdd", "NameGeneratorRoster", "Sociogram", "DyadCensus", "TieStrengthCensus", "Information", "OrdinalBin", "CategoricalBin"] }, "label": { "type": "string" }, "form": { "$ref": "#/definitions/Form" }, "quickAdd": { "type": ["string", "null"] }, "createEdge": { "type": "string" }, "dataSource": { "type": ["string", "null"] }, "subject": { "anyOf": [{ "$ref": "#/definitions/Subject" }, { "type": "array", "minItems": 1, "maxItems": 2, "items": { "$ref": "#/definitions/Subject" } }] }, "panels": { "type": "array", "items": { "$ref": "#/definitions/Panel" } }, "prompts": { "type": "array", "items": { "$ref": "#/definitions/Prompt" }, "minItems": 1 }, "presets": { "type": "array", "items": { "$ref": "#/definitions/Preset" }, "minItems": 1 }, "background": { "type": "object", "properties": { "image": { "type": "string" }, "concentricCircles": { "type": "integer" }, "skewedTowardCenter": { "type": "boolean" } }, "additionalProperties": false, "required": ["concentricCircles", "skewedTowardCenter"] }, "sortOptions": { "$ref": "#/definitions/SortOptions" }, "cardOptions": { "type": "object", "patternProperties": { "^[0-9]{2,6}$": { "$ref": "#/definitions/CardOptions" } } }, "searchOptions": { "$ref": "#/definitions/SearchOptions" }, "behaviours": { "$ref": "#/definitions/Behaviours" }, "showExistingNodes": { "type": "boolean" }, "title": { "type": "string" }, "items": { "type": "array", "items": { "$ref": "#/definitions/Item" } }, "introductionPanel": { "$ref": "#/definitions/IntroductionPanel" }, "skipLogic": { "$ref": "#/definitions/SkipLogic" }, "filter": { "$ref": "#/definitions/Filter" } }, "required": ["id", "label", "type"], "title": "Interface", "anyOf": [{ "properties": { "type": { "const": "EgoForm" } }, "required": ["form"] }, { "properties": { "type": { "const": "DyadCensus" } }, "required": ["subject", "prompts"] }, { "properties": { "type": { "const": "TieStrengthCensus" } }, "required": ["subject", "prompts"] }, { "properties": { "type": { "const": "AlterForm" } }, "required": ["form"] }, { "properties": { "type": { "const": "AlterEdgeForm" } }, "required": ["form"] }, { "properties": { "type": { "const": "Information" } }, "required": ["items"] }, { "properties": { "type": { "const": "Narrative" } }, "required": ["presets", "background"] }, { "properties": { "type": { "enum": ["NameGenerator", "NameGeneratorQuickAdd", "NameGeneratorRoster", "Sociogram", "OrdinalBin", "CategoricalBin", "DyadCensus"] } }, "required": ["prompts"] }] };
const schema360 = { "type": "object", "additionalProperties": false, "properties": { "fuzziness": { "type": "number" }, "matchProperties": { "type": "array", "items": { "type": "string" } } }, "required": ["fuzziness", "matchProperties"], "title": "SearchOptions" };
const schema363 = { "type": "object", "additionalProperties": false, "properties": { "id": { "type": "string" }, "type": { "type": "string", "enum": ["text", "asset"] }, "content": { "type": "string" }, "description": { "type": "string" }, "size": { "type": "string" }, "loop": { "type": "boolean" } }, "required": ["content", "id", "type"], "title": "Item" };
const schema364 = { "type": "object", "additionalProperties": false, "properties": { "title": { "type": "string" }, "text": { "type": "string" } }, "required": ["title", "text"] };
const schema337 = { "type": ["object", "null"], "additionalProperties": false, "properties": { "title": { "type": "string" }, "fields": { "type": "array", "items": { "$ref": "#/definitions/Field" } } }, "required": ["fields"], "title": "Form" };
const schema338 = { "type": "object", "additionalProperties": false, "properties": { "variable": { "type": "string" }, "prompt": { "type": "string" } }, "required": ["variable", "prompt"], "title": "Field" };
function validate430(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if ((!(data && typeof data == "object" && !Array.isArray(data))) && (data !== null)) {
    const err0 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: schema337.type }, message: "must be object,null" };
    if (vErrors === null) {
        vErrors = [err0];
    }
    else {
...
} validate430.errors = vErrors; return errors === 0; }
const schema339 = { "type": "object", "additionalProperties": false, "properties": { "entity": { "$ref": "#/definitions/Entity" }, "type": { "type": "string" } }, "required": ["entity", "type"], "title": "Subject" };
const schema340 = { "type": "string", "enum": ["edge", "node", "ego"], "title": "Entity" };
function validate432(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.entity !== undefined) {
        ...
        if (!(((data0 === "edge") || (data0 === "node")) || (data0 === "ego"))) {
            const err4 = { instancePath: instancePath + "/entity", schemaPath: "#/definitions/Entity/enum", keyword: "enum", params: { allowedValues: schema340.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err4];
            }
            else {
    ...
    errors++;
} validate432.errors = vErrors; return errors === 0; }
const schema341 = { "type": "object", "additionalProperties": false, "properties": { "id": { "type": "string" }, "title": { "type": "string" }, "filter": { "$ref": "#/definitions/Filter" }, "dataSource": { "type": ["string", "null"] } }, "required": ["id", "title", "dataSource"], "title": "Panel" };
const schema342 = { "type": ["object", "null"], "additionalProperties": false, "properties": { "join": { "type": "string", "enum": ["OR", "AND"] }, "rules": { "type": "array", "items": { "$ref": "#/definitions/Rule" } } }, "title": "Filter" };
const schema343 = { "type": "object", "additionalProperties": false, "properties": { "type": { "type": "string", "enum": ["alter", "ego", "edge"] }, "id": { "type": "string" }, "options": { "$ref": "#/definitions/Options" } }, "required": ["id", "options", "type"], "title": "Rule" };
const schema344 = { "type": "object", "additionalProperties": false, "properties": { "type": { "type": "string" }, "attribute": { "type": "string" }, "operator": { "type": "string", "enum": ["EXISTS", "NOT_EXISTS", "EXACTLY", "NOT", "GREATER_THAN", "GREATER_THAN_OR_EQUAL", "LESS_THAN", "LESS_THAN_OR_EQUAL", "INCLUDES", "EXCLUDES", "OPTIONS_GREATER_THAN", "OPTIONS_LESS_THAN", "OPTIONS_EQUALS", "OPTIONS_NOT_EQUALS", "CONTAINS", "DOES NOT CONTAIN"] }, "value": { "type": ["integer", "string", "boolean", "array"] } }, "required": ["operator"], "title": "Rule Options", "allOf": [{ "if": { "properties": { "operator": { "enum": ["EXACTLY", "NOT", "GREATER_THAN", "GREATER_THAN_OR_EQUAL", "LESS_THAN", "LESS_THAN_OR_EQUAL", "INCLUDES", "EXCLUDES", "OPTIONS_GREATER_THAN", "OPTIONS_LESS_THAN", "OPTIONS_EQUALS", "OPTIONS_NOT_EQUALS", "CONTAINS", "DOES NOT CONTAIN"] } } }, "then": { "required": ["value"] } }] };
function validate437(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.type !== undefined) {
        ...
        if (!(((data0 === "alter") || (data0 === "ego")) || (data0 === "edge"))) {
            const err5 = { instancePath: instancePath + "/type", schemaPath: "#/properties/type/enum", keyword: "enum", params: { allowedValues: schema343.properties.type.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err5];
            }
            else {
        ...
        if (data2 && typeof data2 == "object" && !Array.isArray(data2)) {
            ...
            if (data2.operator !== undefined) {
                ...
                if (!((((((((((((((((data6 === "EXISTS") || (data6 === "NOT_EXISTS")) || (data6 === "EXACTLY")) || (data6 === "NOT")) || (data6 === "GREATER_THAN")) || (data6 === "GREATER_THAN_OR_EQUAL")) || (data6 === "LESS_THAN")) || (data6 === "LESS_THAN_OR_EQUAL")) || (data6 === "INCLUDES")) || (data6 === "EXCLUDES")) || (data6 === "OPTIONS_GREATER_THAN")) || (data6 === "OPTIONS_LESS_THAN")) || (data6 === "OPTIONS_EQUALS")) || (data6 === "OPTIONS_NOT_EQUALS")) || (data6 === "CONTAINS")) || (data6 === "DOES NOT CONTAIN"))) {
                    const err15 = { instancePath: instancePath + "/options/operator", schemaPath: "#/definitions/Options/properties/operator/enum", keyword: "enum", params: { allowedValues: schema344.properties.operator.enum }, message: "must be equal to one of the allowed values" };
                    if (vErrors === null) {
                        vErrors = [err15];
                    }
                    else {
            ...
            if (data2.value !== undefined) {
                ...
                if ((((!(((typeof data7 == "number") && (!(data7 % 1) && !isNaN(data7))) && (isFinite(data7)))) && (typeof data7 !== "string")) && (typeof data7 !== "boolean")) && (!(Array.isArray(data7)))) {
                    const err16 = { instancePath: instancePath + "/options/value", schemaPath: "#/definitions/Options/properties/value/type", keyword: "type", params: { type: schema344.properties.value.type }, message: "must be integer,string,boolean,array" };
                    if (vErrors === null) {
                        vErrors = [err16];
                    }
                    else {
    ...
    errors++;
} validate437.errors = vErrors; return errors === 0; }
function validate436(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if ((!(data && typeof data == "object" && !Array.isArray(data))) && (data !== null)) {
    const err0 = { instancePath, schemaPath: "#/type", keyword: "type", params: { type: schema342.type }, message: "must be object,null" };
    if (vErrors === null) {
        vErrors = [err0];
    }
    else {
    ...
    if (data.join !== undefined) {
        ...
        if (!((data0 === "OR") || (data0 === "AND"))) {
            const err3 = { instancePath: instancePath + "/join", schemaPath: "#/properties/join/enum", keyword: "enum", params: { allowedValues: schema342.properties.join.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err3];
            }
            else {
    ...
    if (data.rules !== undefined) {
        ...
        if (Array.isArray(data1)) {
            const len0 = data1.length;
            for (let i0 = 0; i0 < len0; i0++) {
                if (!(validate437(data1[i0], { instancePath: instancePath + "/rules/" + i0, parentData: data1, parentDataProperty: i0, rootData }))) {
...
} validate436.errors = vErrors; return errors === 0; }
function validate435(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
        const err0 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "id" }, message: "must have required property '" + "id" + "'" };
        if (vErrors === null) {
            vErrors = [err0];
    ...
    if (data.filter !== undefined) {
        if (!(validate436(data.filter, { instancePath: instancePath + "/filter", parentData: data, parentDataProperty: "filter", rootData }))) {
    ...
    if (data.dataSource !== undefined) {
        ...
        if ((typeof data3 !== "string") && (data3 !== null)) {
            const err6 = { instancePath: instancePath + "/dataSource", schemaPath: "#/properties/dataSource/type", keyword: "type", params: { type: schema341.properties.dataSource.type }, message: "must be string,null" };
            if (vErrors === null) {
                vErrors = [err6];
            }
            else {
    ...
    errors++;
} validate435.errors = vErrors; return errors === 0; }
const schema345 = { "type": "object", "additionalProperties": false, "properties": { "id": { "type": "string" }, "text": { "type": "string" }, "additionalAttributes": { "$ref": "#/definitions/AdditionalAttributes" }, "variable": { "type": "string" }, "edgeVariable": { "type": "string" }, "negativeLabel": { "type": "string" }, "otherVariable": { "type": "string" }, "otherVariablePrompt": { "type": "string" }, "otherOptionLabel": { "type": "string" }, "bucketSortOrder": { "type": "array", "items": { "$ref": "#/definitions/SortOrder" } }, "binSortOrder": { "type": "array", "items": { "$ref": "#/definitions/SortOrder" } }, "sortOrder": { "type": "array", "items": { "$ref": "#/definitions/SortOrder" } }, "color": { "type": "string" }, "layout": { "$ref": "#/definitions/Layout" }, "edges": { "$ref": "#/definitions/Edges" }, "highlight": { "$ref": "#/definitions/Highlight" }, "createEdge": { "type": "string" } }, "required": ["id", "text"], "title": "Prompt" };
const schema350 = { "type": "object", "additionalProperties": false, "properties": { "layoutVariable": { "anyOf": [{ "type": "string" }, { "type": "object" }] }, "allowPositioning": { "type": "boolean" } }, "required": ["layoutVariable"], "title": "Layout" };
const schema351 = { "type": "object", "additionalProperties": false, "properties": { "display": { "type": "array", "items": { "type": "string" } }, "create": { "type": "string" }, "restrict": { "type": "object", "properties": { "origin": { "type": "string" }, "destination": { "type": "string", "enum": ["same", "different", "all"] } } } }, "required": [], "title": "Edges" };
const schema352 = { "type": "object", "additionalProperties": false, "properties": { "variable": { "type": "string" }, "allowHighlighting": { "type": "boolean" } }, "required": ["allowHighlighting"], "title": "Highlight" };
const schema346 = { "type": "array", "title": "AdditionalAttributes", "items": { "$ref": "#/definitions/AdditionalAttribute" } };
const schema347 = { "type": "object", "additionalProperties": false, "properties": { "variable": { "type": "string" }, "value": { "type": ["boolean"] } }, "required": ["variable", "value"], "title": "AdditionalAttribute" };
function validate442(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (Array.isArray(data)) {
        ...
        if (data0 && typeof data0 == "object" && !Array.isArray(data0)) {
            ...
            if (data0.value !== undefined) {
                if (typeof data0.value !== "boolean") {
                    const err4 = { instancePath: instancePath + "/" + i0 + "/value", schemaPath: "#/definitions/AdditionalAttribute/properties/value/type", keyword: "type", params: { type: schema347.properties.value.type }, message: "must be boolean" };
                    if (vErrors === null) {
                        vErrors = [err4];
                    }
                    else {
    ...
    errors++;
} validate442.errors = vErrors; return errors === 0; }
const schema348 = { "type": "object", "additionalProperties": false, "properties": { "property": { "type": "string" }, "direction": { "$ref": "#/definitions/Direction" }, "type": { "enum": ["string", "number", "boolean", "date", "hierarchy"] }, "hierarchy": { "type": "array", "items": { "type": ["string", "number", "boolean"] } } }, "required": ["property"], "title": "SortOrder" };
const schema349 = { "type": "string", "enum": ["desc", "asc"], "title": "Direction" };
function validate444(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.direction !== undefined) {
        ...
        if (!((data1 === "desc") || (data1 === "asc"))) {
            const err4 = { instancePath: instancePath + "/direction", schemaPath: "#/definitions/Direction/enum", keyword: "enum", params: { allowedValues: schema349.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err4];
            }
            else {
    ...
    if (data.type !== undefined) {
        ...
        if (!(((((data2 === "string") || (data2 === "number")) || (data2 === "boolean")) || (data2 === "date")) || (data2 === "hierarchy"))) {
            const err5 = { instancePath: instancePath + "/type", schemaPath: "#/properties/type/enum", keyword: "enum", params: { allowedValues: schema348.properties.type.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err5];
            }
            else {
        ...
        if (Array.isArray(data3)) {
            ...
            for (let i0 = 0; i0 < len0; i0++) {
                ...
                if (((typeof data4 !== "string") && (!((typeof data4 == "number") && (isFinite(data4))))) && (typeof data4 !== "boolean")) {
                    const err6 = { instancePath: instancePath + "/hierarchy/" + i0, schemaPath: "#/properties/hierarchy/items/type", keyword: "type", params: { type: schema348.properties.hierarchy.items.type }, message: "must be string,number,boolean" };
                    if (vErrors === null) {
                        vErrors = [err6];
                    }
                    else {
    ...
    errors++;
} validate444.errors = vErrors; return errors === 0; }
function validate441(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
        const err0 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "id" }, message: "must have required property '" + "id" + "'" };
        if (vErrors === null) {
            vErrors = [err0];
    ...
    if (data.additionalAttributes !== undefined) {
        if (!(validate442(data.additionalAttributes, { instancePath: instancePath + "/additionalAttributes", parentData: data, parentDataProperty: "additionalAttributes", rootData }))) {
    ...
    if (data.bucketSortOrder !== undefined) {
        ...
        if (Array.isArray(data9)) {
            ...
            for (let i0 = 0; i0 < len0; i0++) {
                if (!(validate444(data9[i0], { instancePath: instancePath + "/bucketSortOrder/" + i0, parentData: data9, parentDataProperty: i0, rootData }))) {
    ...
    if (data.binSortOrder !== undefined) {
        ...
        if (Array.isArray(data11)) {
            ...
            for (let i1 = 0; i1 < len1; i1++) {
                if (!(validate444(data11[i1], { instancePath: instancePath + "/binSortOrder/" + i1, parentData: data11, parentDataProperty: i1, rootData }))) {
                    vErrors = vErrors === null ? validate444.errors : vErrors.concat(validate444.errors);
                    errors = vErrors.length;
                }
            }
    ...
    if (data.sortOrder !== undefined) {
        ...
        if (Array.isArray(data13)) {
            ...
            for (let i2 = 0; i2 < len2; i2++) {
                if (!(validate444(data13[i2], { instancePath: instancePath + "/sortOrder/" + i2, parentData: data13, parentDataProperty: i2, rootData }))) {
                    vErrors = vErrors === null ? validate444.errors : vErrors.concat(validate444.errors);
                    errors = vErrors.length;
                }
            }
                ...
                if (data23 && typeof data23 == "object" && !Array.isArray(data23)) {
                    ...
                    if (data23.destination !== undefined) {
                        ...
                        if (!(((data25 === "same") || (data25 === "different")) || (data25 === "all"))) {
                            const err28 = { instancePath: instancePath + "/edges/restrict/destination", schemaPath: "#/definitions/Edges/properties/restrict/properties/destination/enum", keyword: "enum", params: { allowedValues: schema351.properties.restrict.properties.destination.enum }, message: "must be equal to one of the allowed values" };
                            if (vErrors === null) {
                                vErrors = [err28];
                            }
                            else {
    ...
    errors++;
} validate441.errors = vErrors; return errors === 0; }
const schema353 = { "type": "object", "additionalProperties": false, "properties": { "id": { "type": "string" }, "label": { "type": "string" }, "layoutVariable": { "type": "string" }, "groupVariable": { "type": "string" }, "edges": { "$ref": "#/definitions/Edges" }, "highlight": { "$ref": "#/definitions/NarrativeHighlight" } }, "required": ["id", "label", "layoutVariable"], "title": "Preset" };
const schema355 = { "type": "array", "items": { "type": "string" }, "title": "NarrativeHighlight" };
function validate449(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === undefined) {
        const err0 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "id" }, message: "must have required property '" + "id" + "'" };
        if (vErrors === null) {
            vErrors = [err0];
                ...
                if (data8 && typeof data8 == "object" && !Array.isArray(data8)) {
                    ...
                    if (data8.destination !== undefined) {
                        ...
                        if (!(((data10 === "same") || (data10 === "different")) || (data10 === "all"))) {
                            const err14 = { instancePath: instancePath + "/edges/restrict/destination", schemaPath: "#/definitions/Edges/properties/restrict/properties/destination/enum", keyword: "enum", params: { allowedValues: schema351.properties.restrict.properties.destination.enum }, message: "must be equal to one of the allowed values" };
                            if (vErrors === null) {
                                vErrors = [err14];
                            }
                            else {
    ...
    errors++;
} validate449.errors = vErrors; return errors === 0; }
const schema356 = { "type": "object", "additionalProperties": false, "properties": { "sortOrder": { "type": "array", "items": { "$ref": "#/definitions/SortOrder" } }, "sortableProperties": { "type": "array", "items": { "$ref": "#/definitions/Property" } } }, "required": ["sortOrder", "sortableProperties"], "title": "SortOptions" };
const schema357 = { "type": "object", "additionalProperties": false, "properties": { "label": { "type": "string" }, "variable": { "type": "string" } }, "required": ["label", "variable"], "title": "Property" };
function validate451(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.sortOrder === undefined) {
    ...
    if (data.sortOrder !== undefined) {
        ...
        if (Array.isArray(data0)) {
            ...
            for (let i0 = 0; i0 < len0; i0++) {
                if (!(validate444(data0[i0], { instancePath: instancePath + "/sortOrder/" + i0, parentData: data0, parentDataProperty: i0, rootData }))) {
                    vErrors = vErrors === null ? validate444.errors : vErrors.concat(validate444.errors);
                    errors = vErrors.length;
                }
            }
    ...
    errors++;
} validate451.errors = vErrors; return errors === 0; }
const schema358 = { "type": "object", "additionalProperties": false, "properties": { "displayLabel": { "type": "string" }, "additionalProperties": { "type": "array", "items": { "$ref": "#/definitions/Property" } } }, "required": ["displayLabel"], "title": "CardOptions" };
function validate454(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    errors++;
} validate454.errors = vErrors; return errors === 0; }
const schema361 = { "type": "object", "additionalProperties": true, "properties": { "minNodes": { "type": "integer" }, "maxNodes": { "type": "integer" }, "freeDraw": { "type": "boolean" }, "featureNode": { "type": "boolean" }, "allowRepositioning": { "type": "boolean" }, "automaticLayout": { "$ref": "#/definitions/AutomaticLayout" } }, "required": [], "title": "Behaviours" };
const schema362 = { "type": "object", "additionalProperties": false, "properties": { "enabled": { "type": "boolean" } }, "required": ["enabled"], "title": "AutomaticLayout" };
function validate456(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.automaticLayout !== undefined) {
        ...
        if (data5 && typeof data5 == "object" && !Array.isArray(data5)) {
            if (data5.enabled === undefined) {
                const err5 = { instancePath: instancePath + "/automaticLayout", schemaPath: "#/definitions/AutomaticLayout/required", keyword: "required", params: { missingProperty: "enabled" }, message: "must have required property '" + "enabled" + "'" };
                if (vErrors === null) {
                    vErrors = [err5];
                }
                else {
            ...
            for (const key0 in data5) {
                if (!(key0 === "enabled")) {
                    const err6 = { instancePath: instancePath + "/automaticLayout", schemaPath: "#/definitions/AutomaticLayout/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" };
                    if (vErrors === null) {
                        vErrors = [err6];
                    }
                    else {
            ...
            if (data5.enabled !== undefined) {
                if (typeof data5.enabled !== "boolean") {
                    const err7 = { instancePath: instancePath + "/automaticLayout/enabled", schemaPath: "#/definitions/AutomaticLayout/properties/enabled/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
                    if (vErrors === null) {
                        vErrors = [err7];
                    }
                    else {
            ...
            const err8 = { instancePath: instancePath + "/automaticLayout", schemaPath: "#/definitions/AutomaticLayout/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
                vErrors = [err8];
            }
            else {
    ...
    errors++;
} validate456.errors = vErrors; return errors === 0; }
const schema365 = { "type": "object", "additionalProperties": false, "properties": { "action": { "type": "string", "enum": ["SHOW", "SKIP"] }, "filter": { "$ref": "#/definitions/Filter" } }, "required": ["action", "filter"], "title": "SkipLogic" };
function validate458(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.action !== undefined) {
        ...
        if (!((data0 === "SHOW") || (data0 === "SKIP"))) {
            const err4 = { instancePath: instancePath + "/action", schemaPath: "#/properties/action/enum", keyword: "enum", params: { allowedValues: schema365.properties.action.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err4];
            }
            else {
    ...
    errors++;
} validate458.errors = vErrors; return errors === 0; }
const pattern6 = new RegExp("^[0-9]{2,6}$", "u");
function validate429(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; const _errs1 = errors; let valid0 = false; const _errs2 = errors; if (data && typeof data == "object" && !Array.isArray(data)) {
                            ...
                            if (data && typeof data == "object" && !Array.isArray(data)) {
                                ...
                                if (data.type !== undefined) {
                                    ...
                                    if (!(((((((data7 === "NameGenerator") || (data7 === "NameGeneratorQuickAdd")) || (data7 === "NameGeneratorRoster")) || (data7 === "Sociogram")) || (data7 === "OrdinalBin")) || (data7 === "CategoricalBin")) || (data7 === "DyadCensus"))) {
                                        const err18 = { instancePath: instancePath + "/type", schemaPath: "#/anyOf/7/properties/type/enum", keyword: "enum", params: { allowedValues: schema336.anyOf[7].properties.type.enum }, message: "must be equal to one of the allowed values" };
                                        if (vErrors === null) {
                                            vErrors = [err18];
                                        }
                                        else {
    ...
    if (data.type !== undefined) {
        ...
        if (!(((((((((((((data10 === "Narrative") || (data10 === "AlterForm")) || (data10 === "AlterEdgeForm")) || (data10 === "EgoForm")) || (data10 === "NameGenerator")) || (data10 === "NameGeneratorQuickAdd")) || (data10 === "NameGeneratorRoster")) || (data10 === "Sociogram")) || (data10 === "DyadCensus")) || (data10 === "TieStrengthCensus")) || (data10 === "Information")) || (data10 === "OrdinalBin")) || (data10 === "CategoricalBin"))) {
            const err27 = { instancePath: instancePath + "/type", schemaPath: "#/properties/type/enum", keyword: "enum", params: { allowedValues: schema336.properties.type.enum }, message: "must be equal to one of the allowed values" };
            if (vErrors === null) {
                vErrors = [err27];
            }
            else {
    ...
    if (data.quickAdd !== undefined) {
        ...
        if ((typeof data13 !== "string") && (data13 !== null)) {
            const err29 = { instancePath: instancePath + "/quickAdd", schemaPath: "#/properties/quickAdd/type", keyword: "type", params: { type: schema336.properties.quickAdd.type }, message: "must be string,null" };
            if (vErrors === null) {
                vErrors = [err29];
            }
            else {
    ...
    if (data.dataSource !== undefined) {
        ...
        if ((typeof data15 !== "string") && (data15 !== null)) {
            const err31 = { instancePath: instancePath + "/dataSource", schemaPath: "#/properties/dataSource/type", keyword: "type", params: { type: schema336.properties.dataSource.type }, message: "must be string,null" };
            if (vErrors === null) {
                vErrors = [err31];
            }
            else {
    ...
    if (data.subject !== undefined) {
        ...
        let valid10 = false;
        const _errs36 = errors;
        if (!(validate432(data16, { instancePath: instancePath + "/subject", parentData: data, parentDataProperty: "subject", rootData }))) {
        ...
        if (!valid10) {
            ...
            if (Array.isArray(data16)) {
                if (data16.length > 2) {
                    const err32 = { instancePath: instancePath + "/subject", schemaPath: "#/properties/subject/anyOf/1/maxItems", keyword: "maxItems", params: { limit: 2 }, message: "must NOT have more than 2 items" };
                    if (vErrors === null) {
                        vErrors = [err32];
                    }
                    else {
                ...
                if (data16.length < 1) {
                    const err33 = { instancePath: instancePath + "/subject", schemaPath: "#/properties/subject/anyOf/1/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items" };
                    if (vErrors === null) {
                        vErrors = [err33];
                    }
                    else {
                ...
                for (let i0 = 0; i0 < len0; i0++) {
                    if (!(validate432(data16[i0], { instancePath: instancePath + "/subject/" + i0, parentData: data16, parentDataProperty: i0, rootData }))) {
                        vErrors = vErrors === null ? validate432.errors : vErrors.concat(validate432.errors);
                        errors = vErrors.length;
                    }
                }
                ...
                const err34 = { instancePath: instancePath + "/subject", schemaPath: "#/properties/subject/anyOf/1/type", keyword: "type", params: { type: "array" }, message: "must be array" };
                if (vErrors === null) {
                    vErrors = [err34];
                }
                else {
        ...
        if (!valid10) {
            const err35 = { instancePath: instancePath + "/subject", schemaPath: "#/properties/subject/anyOf", keyword: "anyOf", params: {}, message: "must match a schema in anyOf" };
            if (vErrors === null) {
                vErrors = [err35];
            }
            else {
    ...
    if (data.panels !== undefined) {
        ...
        if (Array.isArray(data18)) {
            ...
            for (let i1 = 0; i1 < len1; i1++) {
                if (!(validate435(data18[i1], { instancePath: instancePath + "/panels/" + i1, parentData: data18, parentDataProperty: i1, rootData }))) {
            ...
            const err36 = { instancePath: instancePath + "/panels", schemaPath: "#/properties/panels/type", keyword: "type", params: { type: "array" }, message: "must be array" };
            if (vErrors === null) {
                vErrors = [err36];
            }
            else {
    ...
    if (data.prompts !== undefined) {
        ...
        if (Array.isArray(data20)) {
            if (data20.length < 1) {
                const err37 = { instancePath: instancePath + "/prompts", schemaPath: "#/properties/prompts/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items" };
                if (vErrors === null) {
                    vErrors = [err37];
                }
                else {
            ...
            for (let i2 = 0; i2 < len2; i2++) {
                if (!(validate441(data20[i2], { instancePath: instancePath + "/prompts/" + i2, parentData: data20, parentDataProperty: i2, rootData }))) {
            ...
            const err38 = { instancePath: instancePath + "/prompts", schemaPath: "#/properties/prompts/type", keyword: "type", params: { type: "array" }, message: "must be array" };
            if (vErrors === null) {
                vErrors = [err38];
            }
            else {
    ...
    if (data.presets !== undefined) {
        ...
        if (Array.isArray(data22)) {
            if (data22.length < 1) {
                const err39 = { instancePath: instancePath + "/presets", schemaPath: "#/properties/presets/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items" };
                if (vErrors === null) {
                    vErrors = [err39];
                }
                else {
            ...
            for (let i3 = 0; i3 < len3; i3++) {
                if (!(validate449(data22[i3], { instancePath: instancePath + "/presets/" + i3, parentData: data22, parentDataProperty: i3, rootData }))) {
            ...
            const err40 = { instancePath: instancePath + "/presets", schemaPath: "#/properties/presets/type", keyword: "type", params: { type: "array" }, message: "must be array" };
            if (vErrors === null) {
                vErrors = [err40];
            }
            else {
    ...
    if (data.background !== undefined) {
        ...
        if (data24 && typeof data24 == "object" && !Array.isArray(data24)) {
            if (data24.concentricCircles === undefined) {
                const err41 = { instancePath: instancePath + "/background", schemaPath: "#/properties/background/required", keyword: "required", params: { missingProperty: "concentricCircles" }, message: "must have required property '" + "concentricCircles" + "'" };
                if (vErrors === null) {
                    vErrors = [err41];
                }
                else {
            ...
            if (data24.skewedTowardCenter === undefined) {
                const err42 = { instancePath: instancePath + "/background", schemaPath: "#/properties/background/required", keyword: "required", params: { missingProperty: "skewedTowardCenter" }, message: "must have required property '" + "skewedTowardCenter" + "'" };
                if (vErrors === null) {
                    vErrors = [err42];
                }
                else {
            ...
            for (const key1 in data24) {
                if (!(((key1 === "image") || (key1 === "concentricCircles")) || (key1 === "skewedTowardCenter"))) {
                    const err43 = { instancePath: instancePath + "/background", schemaPath: "#/properties/background/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key1 }, message: "must NOT have additional properties" };
                    if (vErrors === null) {
                        vErrors = [err43];
                    }
                    else {
            ...
            if (data24.image !== undefined) {
                if (typeof data24.image !== "string") {
                    const err44 = { instancePath: instancePath + "/background/image", schemaPath: "#/properties/background/properties/image/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                    if (vErrors === null) {
                        vErrors = [err44];
                    }
                    else {
            ...
            if (data24.concentricCircles !== undefined) {
                ...
                if (!(((typeof data26 == "number") && (!(data26 % 1) && !isNaN(data26))) && (isFinite(data26)))) {
                    const err45 = { instancePath: instancePath + "/background/concentricCircles", schemaPath: "#/properties/background/properties/concentricCircles/type", keyword: "type", params: { type: "integer" }, message: "must be integer" };
                    if (vErrors === null) {
                        vErrors = [err45];
                    }
                    else {
            ...
            if (data24.skewedTowardCenter !== undefined) {
                if (typeof data24.skewedTowardCenter !== "boolean") {
                    const err46 = { instancePath: instancePath + "/background/skewedTowardCenter", schemaPath: "#/properties/background/properties/skewedTowardCenter/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
                    if (vErrors === null) {
                        vErrors = [err46];
                    }
                    else {
            ...
            const err47 = { instancePath: instancePath + "/background", schemaPath: "#/properties/background/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
                vErrors = [err47];
            }
            else {
    ...
    if (data.sortOptions !== undefined) {
        if (!(validate451(data.sortOptions, { instancePath: instancePath + "/sortOptions", parentData: data, parentDataProperty: "sortOptions", rootData }))) {
        ...
        if (data29 && typeof data29 == "object" && !Array.isArray(data29)) {
            for (const key2 in data29) {
                if (pattern6.test(key2)) {
                    if (!(validate454(data29[key2], { instancePath: instancePath + "/cardOptions/" + key2.replace(/~/g, "~0").replace(/\//g, "~1"), parentData: data29, parentDataProperty: key2, rootData }))) {
            ...
            const err48 = { instancePath: instancePath + "/cardOptions", schemaPath: "#/properties/cardOptions/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
                vErrors = [err48];
            }
            else {
        ...
        if (data31 && typeof data31 == "object" && !Array.isArray(data31)) {
            ...
            for (const key3 in data31) {
                if (!((key3 === "fuzziness") || (key3 === "matchProperties"))) {
                    const err51 = { instancePath: instancePath + "/searchOptions", schemaPath: "#/definitions/SearchOptions/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key3 }, message: "must NOT have additional properties" };
                    if (vErrors === null) {
                        vErrors = [err51];
                    }
                    else {
                ...
                if (Array.isArray(data33)) {
                    ...
                    for (let i4 = 0; i4 < len4; i4++) {
                        if (typeof data33[i4] !== "string") {
                            const err53 = { instancePath: instancePath + "/searchOptions/matchProperties/" + i4, schemaPath: "#/definitions/SearchOptions/properties/matchProperties/items/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err53];
                            }
                            else {
    ...
    if (data.behaviours !== undefined) {
        if (!(validate456(data.behaviours, { instancePath: instancePath + "/behaviours", parentData: data, parentDataProperty: "behaviours", rootData }))) {
    ...
    if (data.showExistingNodes !== undefined) {
        if (typeof data.showExistingNodes !== "boolean") {
            const err56 = { instancePath: instancePath + "/showExistingNodes", schemaPath: "#/properties/showExistingNodes/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
            if (vErrors === null) {
                vErrors = [err56];
            }
            else {
    ...
    if (data.title !== undefined) {
        if (typeof data.title !== "string") {
            const err57 = { instancePath: instancePath + "/title", schemaPath: "#/properties/title/type", keyword: "type", params: { type: "string" }, message: "must be string" };
            if (vErrors === null) {
                vErrors = [err57];
            }
            else {
    ...
    if (data.items !== undefined) {
        ...
        if (Array.isArray(data38)) {
            ...
            for (let i5 = 0; i5 < len5; i5++) {
                ...
                if (data39 && typeof data39 == "object" && !Array.isArray(data39)) {
                    if (data39.content === undefined) {
                        const err58 = { instancePath: instancePath + "/items/" + i5, schemaPath: "#/definitions/Item/required", keyword: "required", params: { missingProperty: "content" }, message: "must have required property '" + "content" + "'" };
                        if (vErrors === null) {
                            vErrors = [err58];
                        }
                        else {
                    ...
                    if (data39.id === undefined) {
                        const err59 = { instancePath: instancePath + "/items/" + i5, schemaPath: "#/definitions/Item/required", keyword: "required", params: { missingProperty: "id" }, message: "must have required property '" + "id" + "'" };
                        if (vErrors === null) {
                            vErrors = [err59];
                        }
                        else {
                    ...
                    if (data39.type === undefined) {
                        const err60 = { instancePath: instancePath + "/items/" + i5, schemaPath: "#/definitions/Item/required", keyword: "required", params: { missingProperty: "type" }, message: "must have required property '" + "type" + "'" };
                        if (vErrors === null) {
                            vErrors = [err60];
                        }
                        else {
                    ...
                    for (const key4 in data39) {
                        if (!((((((key4 === "id") || (key4 === "type")) || (key4 === "content")) || (key4 === "description")) || (key4 === "size")) || (key4 === "loop"))) {
                            const err61 = { instancePath: instancePath + "/items/" + i5, schemaPath: "#/definitions/Item/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key4 }, message: "must NOT have additional properties" };
                            if (vErrors === null) {
                                vErrors = [err61];
                            }
                            else {
                    ...
                    if (data39.id !== undefined) {
                        if (typeof data39.id !== "string") {
                            const err62 = { instancePath: instancePath + "/items/" + i5 + "/id", schemaPath: "#/definitions/Item/properties/id/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err62];
                            }
                            else {
                    ...
                    if (data39.type !== undefined) {
                        ...
                        if (typeof data41 !== "string") {
                            const err63 = { instancePath: instancePath + "/items/" + i5 + "/type", schemaPath: "#/definitions/Item/properties/type/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err63];
                            }
                            else {
                        ...
                        if (!((data41 === "text") || (data41 === "asset"))) {
                            const err64 = { instancePath: instancePath + "/items/" + i5 + "/type", schemaPath: "#/definitions/Item/properties/type/enum", keyword: "enum", params: { allowedValues: schema363.properties.type.enum }, message: "must be equal to one of the allowed values" };
                            if (vErrors === null) {
                                vErrors = [err64];
                            }
                            else {
                    ...
                    if (data39.content !== undefined) {
                        if (typeof data39.content !== "string") {
                            const err65 = { instancePath: instancePath + "/items/" + i5 + "/content", schemaPath: "#/definitions/Item/properties/content/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err65];
                            }
                            else {
                    ...
                    if (data39.description !== undefined) {
                        if (typeof data39.description !== "string") {
                            const err66 = { instancePath: instancePath + "/items/" + i5 + "/description", schemaPath: "#/definitions/Item/properties/description/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err66];
                            }
                            else {
                    ...
                    if (data39.size !== undefined) {
                        if (typeof data39.size !== "string") {
                            const err67 = { instancePath: instancePath + "/items/" + i5 + "/size", schemaPath: "#/definitions/Item/properties/size/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                            if (vErrors === null) {
                                vErrors = [err67];
                            }
                            else {
                    ...
                    if (data39.loop !== undefined) {
                        if (typeof data39.loop !== "boolean") {
                            const err68 = { instancePath: instancePath + "/items/" + i5 + "/loop", schemaPath: "#/definitions/Item/properties/loop/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
                            if (vErrors === null) {
                                vErrors = [err68];
                            }
                            else {
                    ...
                    const err69 = { instancePath: instancePath + "/items/" + i5, schemaPath: "#/definitions/Item/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                    if (vErrors === null) {
                        vErrors = [err69];
                    }
                    else {
            ...
            const err70 = { instancePath: instancePath + "/items", schemaPath: "#/properties/items/type", keyword: "type", params: { type: "array" }, message: "must be array" };
            if (vErrors === null) {
                vErrors = [err70];
            }
            else {
    ...
    if (data.introductionPanel !== undefined) {
        ...
        if (data46 && typeof data46 == "object" && !Array.isArray(data46)) {
            if (data46.title === undefined) {
                const err71 = { instancePath: instancePath + "/introductionPanel", schemaPath: "#/definitions/IntroductionPanel/required", keyword: "required", params: { missingProperty: "title" }, message: "must have required property '" + "title" + "'" };
                if (vErrors === null) {
                    vErrors = [err71];
                }
                else {
            ...
            if (data46.text === undefined) {
                const err72 = { instancePath: instancePath + "/introductionPanel", schemaPath: "#/definitions/IntroductionPanel/required", keyword: "required", params: { missingProperty: "text" }, message: "must have required property '" + "text" + "'" };
                if (vErrors === null) {
                    vErrors = [err72];
                }
                else {
            ...
            for (const key5 in data46) {
                if (!((key5 === "title") || (key5 === "text"))) {
                    const err73 = { instancePath: instancePath + "/introductionPanel", schemaPath: "#/definitions/IntroductionPanel/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key5 }, message: "must NOT have additional properties" };
                    if (vErrors === null) {
                        vErrors = [err73];
                    }
                    else {
            ...
            if (data46.title !== undefined) {
                if (typeof data46.title !== "string") {
                    const err74 = { instancePath: instancePath + "/introductionPanel/title", schemaPath: "#/definitions/IntroductionPanel/properties/title/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                    if (vErrors === null) {
                        vErrors = [err74];
                    }
                    else {
            ...
            if (data46.text !== undefined) {
                if (typeof data46.text !== "string") {
                    const err75 = { instancePath: instancePath + "/introductionPanel/text", schemaPath: "#/definitions/IntroductionPanel/properties/text/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                    if (vErrors === null) {
                        vErrors = [err75];
                    }
                    else {
            ...
            const err76 = { instancePath: instancePath + "/introductionPanel", schemaPath: "#/definitions/IntroductionPanel/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            if (vErrors === null) {
                vErrors = [err76];
            }
            else {
    ...
    if (data.skipLogic !== undefined) {
        if (!(validate458(data.skipLogic, { instancePath: instancePath + "/skipLogic", parentData: data, parentDataProperty: "skipLogic", rootData }))) {
    ...
    errors++;
} validate429.errors = vErrors; return errors === 0; }
function validate406(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    errors++;
} validate406.errors = vErrors; return errors === 0; }
function validate405(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (!(validate406(data, { instancePath, parentData, parentDataProperty, rootData }))) {
    vErrors = vErrors === null ? validate406.errors : vErrors.concat(validate406.errors);
    errors = vErrors.length;
} validate405.errors = vErrors; return errors === 0; }
