            ...
            if ((data && typeof data === "object" && !Array.isArray(data))) {
                        ...
                        if (Array.isArray(data1)) {
                            ...
                            for (var i2 = 0; i2 < data1.length; i2++) {
                                ...
                                if (!refVal[18](data1[i2], (dataPath || '') + '.subject[' + i2 + ']', data1, i2, rootData)) {
                                    if (vErrors === null)
                                        vErrors = refVal[18].errors;
                                    else
                                        vErrors = vErrors.concat(refVal[18].errors);
                                    errors = vErrors.length;
                                }
                                var valid3 = errors === errs_3;
                            }
                    ...
                    if (Array.isArray(data1)) {
                        ...
                        for (var i1 = 0; i1 < data1.length; i1++) {
                            ...
                            if (!refVal39(data1[i1], (dataPath || '') + '.behaviours[' + i1 + ']', data1, i1, rootData)) {
                                if (vErrors === null)
                                    vErrors = refVal39.errors;
                                else
                                    vErrors = vErrors.concat(refVal39.errors);
                                errors = vErrors.length;
                            }
                            var valid2 = errors === errs_2;
                        }
                ...
                if (data.skipLogic !== undefined) {
                    ...
                    if (!refVal43(data.skipLogic, (dataPath || '') + '.skipLogic', data, 'skipLogic', rootData)) {
                        if (vErrors === null)
                            vErrors = refVal43.errors;
                        else
                            vErrors = vErrors.concat(refVal43.errors);
                        errors = vErrors.length;
                    }
                    var valid1 = errors === errs_1;
                }
