...
import { addProtocol, protocolAdded, selectAllProtocols } from '../../slices/protocols.slice';
...
const TestSection = () => {
  ...
  const handleCreateProtocol = () => dispatch(addProtocol({ id: uuid(), name: 'Test Protocol' }));
