...
export const makeGetIds = () =>
  createSelector(propStageId, propPromptId, (stageId, promptId) => ({
    stageId,
    promptId,
  }));

export const makeGetAdditionalAttributes = () =>
  createSelector(propStage, propPrompt, (stage, prompt) =>
    getAdditionalAttributes(stage, prompt),
  );

export const makeGetSubject = () =>
  createSelector(propStage, propPrompt, (stage, prompt) =>
    getSubject(stage, prompt),
  );
...
export const makeGetSubjectType = () =>
  createSelector(
    ...
    (codebook, subject) => {
      ...
      assert(
        nodeTypeIsDefined(codebook, subject.type),
        `Node type "${subject.type}" is not defined in the registry`,
      );
      return subject?.type;
    },
  );

export const makeGetNodeVariables = () =>
 ...
 */
export const makeNetworkEntitiesForType = () =>
  createSelector(
