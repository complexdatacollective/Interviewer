...
const SubMenu = (props) => {
  const { setShowSubMenu, setExpanded, openSettingsMenu, endSession } = props;
  ...
  return (
    ...
    >
      <motion.article layout className="sub-menu__wrapper">
        ...
        <motion.div className="sub-menu__exit" variants={itemVariants}>
...
export default compose(connect(null, mapDispatchToProps))(SubMenu);
