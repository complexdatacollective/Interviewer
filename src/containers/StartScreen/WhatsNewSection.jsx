...
const WhatsNewSection = () => {
  const showWhatsNew = useSelector(
    (state) => state.deviceSettings.showWhatsNew,
  );

  const dispatch = useDispatch();
  const dismissSection = () =>
    dispatch(deviceActions.toggleSetting('showWhatsNew'));
        ...
        <Section className="start-screen-section whats-new-section">
          <main className="whats-new-section__content">
            ...
            <div className="content-section">
              <p>
                Welcome to the stable release of Interviewer. In future
                versions, this card will be used to summarize changes and new
                features.
              </p>
            </div>
          </main>
          <footer className="whats-new-section__footer">
            <Button key="unpair" color="platinum" onClick={dismissSection}>
              Dismiss
            </Button>
          </footer>
        </Section>
