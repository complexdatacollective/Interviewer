...
class NameGeneratorAutoComplete extends Component {
  onSearchComplete = (selectedResults) => {
    const { newNodeModelData, batchAddNodes, newNodeAttributes, stage } =
      this.props;
    ...
    batchAddNodes(withNewModelData, newNodeAttributes, stage.subject.type);
  };
  ...
  render() {
    ...
    searchOptions.matchProperties = searchOptions.matchProperties.map(
      (prop) => {
